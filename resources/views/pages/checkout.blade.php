                        ...
                        <form action="/payment" method="POST">
                            ...
                            <div class="tab">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="name" name="name" value="{{Auth()->user()->first_name . " " . Auth()->user()->last_name}}" class="w-2/4 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-red-500">
                                </div>
                                <div class="mb-4">
                                    <label for="address" class="block text-sky-900 text-sm font-bold mb-2">Street Address</label>
                                    <input {{-- required --}} type="text" id="shippingAddressId" name="address" placeholder="Enter Street Address" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-red-500">
                                    <p id="addressError"></p>
                                </div>
                                <div class="flex flex-col mb-4 sm:items-center sm:flex-row ">
                                    <div class="w-full sm:w-2/4 mx-1">
                                        ...
                                        <input {{-- required --}} type="text" id="cityId" name="city" placeholder="Enter City" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-red-500">
                                        <p id="addressError"></p>
                                    </div>
                                    <div class="w-full sm:w-2/4 mx-1">
                                        <label for="address" class="block text-sky-900 text-sm font-bold mb-2">State</label>
                                        <input {{-- required --}} type="text" id="stateId" name="state" placeholder="Enter State" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-red-500">
                                        <p id="addressError"></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-col mb-4 sm:items-center sm:flex-row">
                                    <div class="w-full sm:w-2/4 mx-1">
                                        ...
                                        <select name="country" class="block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-red-500">
                                    ...
                                    <div class="w-full sm:w-2/4 mx-1">
                                        ...
                                        <input type="number" id="phoneId" name="phoneNumber" placeholder="Enter your phone number" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-red-500">
                                    </div>
                                </div>
                            ...
                            <div class="tab hidden text-sky-900 text-sm font-bold">
                                ...
                                <div class="m-auto w-11/12 ">
                                    ...
                                    <div class="flex items-center w-10/12 m-auto bg-white-100">
                                        <div class="flex items-center">
                                            <input type="radio" id="paypal" name="payment_method" value="paypal" class="form-radio h-5 w-5 text-indigo-600 mr-5">
                                        </div>
                                    ...
                                    <div class="flex items-center w-10/12 m-auto bg-white-100">
                                        <div class="flex items-center">
                                            <input type="radio" id="cod" name="payment_method" value="cod" class="form-radio h-5 w-5 text-indigo-600 mr-5">
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <div>
                                ...
                                <div class="flex justify-end">
                                    ...
                                    <button type="submit" class="block px-4 py-3 bg-red-500 text-white">
                                        CHECKOUT
                                    </button>
                                </div>                 
                            </div>
                            <div class="mt-10">
                                <button type="button" class="hidden px-3 py-2 bg-red-500 text-white" id="backTabId">Back</button>
                                <button type="button" class="px-3 py-2 bg-red-500 text-white" id="nextTabId">Next</button>
                            </div>
                        </form>   
                    @endauth
                </div>
